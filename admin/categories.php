            ...
            <div class="card">
              ...
              <?php 
                ...
                if(empty($_POST['search']) && empty($_COOKIE['search'])){
                  ...
                  $stmt1=$pdo->prepare("SELECT * FROM categories ORDER BY id DESC LIMIT $offset,$numOfRecs ");
                  $stmt1->execute();
                  ...
                  $stmt1=$pdo->prepare("SELECT * FROM categories WHERE name LIKE '%$searchKey%' ORDER BY id DESC LIMIT $offset,$numOfRecs ");
                  $stmt1->execute();
                  $result=$stmt1->fetchAll();
                }
              ?> 
                    ...
                    if($result){
                      foreach ($result as $value) {
                        ...
                        <tr>
                          ...
                          <div class="btn-group">
                            <div class="container">
                              <a href="cat_edit.php?id=<?php echo $value['id'];?>&pageno=<?php echo $pageno ?>" type="button" class="btn btn-warning">Edit</a>
                            </div>
                            <div class="container">
                              <a href="cat_delete.php?id=<?php echo $value['id'];?>&pageno=<?php echo $pageno ?>" type="button" class="btn btn-danger" onclick="return confirm ('Are you sure want to delete')">Delete</a>
                            </div>
                          </div>
                          </td>
                        </tr>
